...
export default function Form_Page() {
  return (
    <div>
        <Header />
        <div className = ' parent w-full h-[1440px] bg-[#F5F5F5] relative '>
            <form className='w-[805px] h-[1048px] bg-[#FFFFFF] absolute top-[100px] left-[82px]' >
                ...
                <div className='flex items-center'>
                 ...
                 <div className='w-[760px] h-[48px] bg-[#F5F5F5] mx-auto flex items-center pl-4'>
                    <p className=''>Important: Enter name as mentioned on your passport or Government approved IDs.</p>
                 </div>
...
<div class="flex flex-wrap gap-4">
  <div class="flex flex-col">
    <label for="firstName" class="mb-1 text-sm font-medium text-gray-700">First Name</label>
    <input type="text" id="firstName" name="firstName" placeholder="John"
           class="w-48  px-3 py-2 border border-gray-300  focus:outline-none focus:ring-2 focus:ring-blue-500" required/>
  </div>

  <div class="flex flex-col">
    <label for="middleName" class="mb-1 text-sm font-medium text-gray-700">Middle Name</label>
    <input type="text" id="middleName" name="middleName" placeholder="Doe"
           class="w-48 px-3 py-2 border border-gray-300  focus:outline-none focus:ring-2 focus:ring-blue-500" />
  </div>

  <div class="flex flex-col">
    <label for="lastName" class="mb-1 text-sm font-medium text-gray-700">Last Name</label>
