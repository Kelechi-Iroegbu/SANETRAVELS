...
export default function Booking_Card(props) {
  return (
    <div className="w-[850px] h-[250px] bg-[#FFFFFF] border-none">
       <div className=' flex pl-4 space-x-12'>
        ...
        <div className='flex-wrap '>
         <h6>Depart</h6>
         <p>{props.data.dateto}</p>
         <p>{props.data.timeto}</p>
        </div>
        </div>

        <div className='text-center'>
            <p className='border-b border-dashed w-[187px]'>2h 35m</p>
            <p>Non-Stop</p>
        ...
        <button className='w-[449px] h-[48px] rounded-sm bg-[#E49D42] border-t'>Flight Details</button>
        </div>
        </div>
        <div className='pt-29'>
        <p>starting from</p>
